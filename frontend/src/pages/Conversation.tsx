...
const statusStyle: Record<string, string> = { proposed: "bg-gold/15 text-ink", accepted: "bg-[#dce9df]/15 text-ink", payment_pending: "bg-gold/15 text-ink", paid: "bg-[#dce9df]/15 text-ink", in_progress: "bg-ink/10 text-ink", delivered: "bg-[#dce9df]/15 text-ink", completed: "bg-[#dce9df]/20 text-ink", rejected: "bg-ink/5 text-ink/50", cancelled: "bg-ink/5 text-ink/50", refunded: "bg-ink/5 text-ink/50", disputed: "bg-[#dce9df]/20 text-ink" };
...
export function Conversation() {
  ...
  return <div className="min-h-screen bg-[#f4ede2] text-ink font-body flex flex-col">
