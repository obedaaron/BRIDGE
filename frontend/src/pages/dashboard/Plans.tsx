...
const fallbackPlans: Plan[] = [
  { tier: "free", amountKobo: 0, currency: "USD", label: "Free", listingLimit: 10, promotionLimit: 0, customization: "Basic storefront" },
  { tier: "standard", amountKobo: 4500, currency: "USD", label: "Standard", listingLimit: 50, promotionLimit: 2, customization: "Expanded storefront" },
  { tier: "premium", amountKobo: 8000, currency: "USD", label: "Premium", listingLimit: null, promotionLimit: null, customization: "Full storefront" },
];
