      ...
      {mobileOpen && (
        <div className="lg:hidden fixed inset-0 z-30 bg-[#2E8B72] text-paper pt-20 px-5 pb-8">
          ...
          <div className="mt-8 pt-6 border-t border-white/10">
            <p className="text-sm text-paper/65 truncate">{user?.email}</p>
            <button onClick={logout} className="mt-3 inline-flex items-center gap-2 text-sm text-paper/65 hover:text-paper transition-colors">
      ...
      <div className="hidden lg:flex min-h-screen">
        ...
        <aside className="w-64 bg-[#2E8B72] text-paper flex flex-col px-6 py-8 sticky top-0 h-screen">
          ...
          <div className="relative z-10 flex flex-col h-full">
            ...
            <Link to="/explore" className="text-xs text-paper/65 hover:text-paper mb-10 inline-flex items-center gap-1 transition-colors">
            ...
            <div className="mt-auto pt-6 border-t border-white/10">
              <p className="text-sm text-paper/55 truncate">{user?.email}</p>
              <button onClick={logout} className="mt-3 inline-flex items-center gap-2 text-sm text-paper/55 hover:text-paper transition-colors">
                <LogOut className="w-4 h-4" strokeWidth={1.5} />
                Log out
              </button>
            </div>
